...
class mainWindow(QWidget):
    ...
    def initUI(self):
        ...
        self.cipherComboBox.setFixedWidth(
            self.frameSize().toTuple()[0] * 2 / 4)
        ...
        # Doesn't work really. Produces an empty stylesheet. I wonder where I
        # can find the stupid CSS template example...
        ...
        # Makes much sense, because what kind of function accepts arguments?
        # ./s
        ...
        # self.buildChanges, self.cipherComboBox.currentText(),
        # self.previousCipher))
    ...
    def buildChanges(self) -> None:
        ...
        if self.cipherComboBox.currentText(
        ) == "Monoalphabetic" and self.previousCipher != self.cipherComboBox.currentText():
            self.trackChanges("Monoalphabetic")
        if self.cipherComboBox.currentText(
        ) == "Caesar" and self.previousCipher != self.cipherComboBox.currentText():
            ...
            def showMessage():
                ...
                for index in range(len(messageInput.text())):
                    ...
                    if (ord(char) >= 65 and ord(char) <= 90):
                        array = array + \
                            chr((ord(char) + shiftDial.value() - 67) % 26 + 65)
                    elif (ord(char) >= 97 and ord(char) <= 122):
                        array = array + \
                            chr((ord(char) + shiftDial.value() - 97) % 26 + 97)
                    else:
                        array = array + char
